...
function initializeMap(config) {
  ...
  (0,esri_loader__WEBPACK_IMPORTED_MODULE_0__.loadModules)(['esri/views/MapView', 'esri/WebMap', 'esri/core/urlUtils', 'esri/config', "esri/layers/WebTileLayer"]).then(async ([MapView, WebMap, urlUtils, esriConfig, WebTileLayer]) => {
    ...
    var webmap = new WebMap({
      ...
      layers: [googleLayer, googleLayerStallite]
    });
    mapView = new MapView({
      map: webmap,
    ...
    config.applicationMode == 'edit' || config.applicationMode == 'add' || config.applicationMode == 'delete' ? addSketchTool(graphicLayer, mapView, "bottom-right", config) : null;
  ...
  setTimeout(() => {
    (0,_services_arc_gis__WEBPACK_IMPORTED_MODULE_3__.addBaseMapToggle)(mapView, "bottom-left");
  }, 3000);
}

function getDirection() {
  var dir;
  dir = document.documentElement.dir === "rtl" ? "bottom-right" : "top-left";
  return dir;
}
...
function perparingBillboardsSelectControl(data, config) {
  ...
  document.documentElement.dir === "ltr" ? div.setAttribute("id", "selectItem") : div.setAttribute("id", "selectItemRtl");
...
var ___CSS_LOADER_EXPORT___ = _node_modules_css_loader_dist_runtime_api_js__WEBPACK_IMPORTED_MODULE_1___default()((_node_modules_css_loader_dist_runtime_cssWithMappingToString_js__WEBPACK_IMPORTED_MODULE_0___default()));
// Module
___CSS_LOADER_EXPORT___.push([module.id, "select#billboardsSelect {\r\n    position: absolute;\r\n    top: 2px;\r\n    right: 25px; \r\n    direction: rtl;\r\n    width: 200px;\r\n}\r\n\r\ndiv#selectItem{\r\n    position: absolute;\r\n    top: 0.5em;\r\n    right: 25px;\r\n    direction: rtl;\r\n}\r\n\r\ndiv#selectItemRtl{\r\n    position: absolute;\r\n    top: 0.5em;\r\n    left: 220px;\r\n    direction: rtl;\r\n}\r\n\r\n\r\n", "",{"version":3,"sources":["webpack://./src/plugins/billboardsSelect.css"],"names":[],"mappings":"AAAA;IACI,kBAAkB;IAClB,QAAQ;IACR,WAAW;IACX,cAAc;IACd,YAAY;AAChB;;AAEA;IACI,kBAAkB;IAClB,UAAU;IACV,WAAW;IACX,cAAc;AAClB;;AAEA;IACI,kBAAkB;IAClB,UAAU;IACV,WAAW;IACX,cAAc;AAClB","sourcesContent":["select#billboardsSelect {\r\n    position: absolute;\r\n    top: 2px;\r\n    right: 25px; \r\n    direction: rtl;\r\n    width: 200px;\r\n}\r\n\r\ndiv#selectItem{\r\n    position: absolute;\r\n    top: 0.5em;\r\n    right: 25px;\r\n    direction: rtl;\r\n}\r\n\r\ndiv#selectItemRtl{\r\n    position: absolute;\r\n    top: 0.5em;\r\n    left: 220px;\r\n    direction: rtl;\r\n}\r\n\r\n\r\n"],"sourceRoot":""}]);
// Exports
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (___CSS_LOADER_EXPORT___);
